<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchItem.aspx.cs" Inherits="order_SearchItem" %>
                ...
                <div class="common_mainwrap mr-243">
                    <div class="sidemenu">
                        <ul id="ul" runat="server">
                            ...
                            <%--<h4 class="h4"><a href="SearchDetail.aspx">0.9%氯化钠注射液</a></h4>
                            <li>适应症：各种原因所致的失水，包括低渗性、等渗性和高渗性失水；高渗性非酮症糖尿病昏迷，应用等渗或低渗氯化钠可纠正失水和高渗状态；低氯性代谢性碱中毒；外用生理盐水冲洗眼部、洗涤伤口等；还用于产科的水囊引产。</li>--%>
                        </ul>
                    </div>
                </div>
            </div>
