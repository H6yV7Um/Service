<%@ Page Language="C#" AutoEventWireup="true" CodeFile="category_list.aspx.cs" Inherits="order_category_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="category_edit.aspx?action=Add"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td>
      ...
      <a href="category_list_item.aspx?id=<%#Eval("id")%>"><%#Eval("typeName")%></a>
    </td>
    <td align="center">
      <a href="category_edit.aspx?action=Add&id=<%#Eval("id")%>">添加子目录</a>
      <%--<a href="category_edit.aspx?action=Edit&id=<%#Eval("id")%>">修改</a>--%>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
