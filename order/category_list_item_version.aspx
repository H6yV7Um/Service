<%@ Page Language="C#" AutoEventWireup="true" CodeFile="category_list_item_version.aspx.cs" Inherits="order_category_list_item_version" %>
...
<ItemTemplate>
  ...
  <tr>
    ...
    <td><a href="download.aspx?id_version=<%#Eval("id")%>"><%# Eval("fileName")%></a></td>
    <td><%# HumanReadableFilesize(Convert.ToDouble(Eval("fileSize")))%></td>
    <td><%# getUserName(Eval("username").ToString())%></td>
    <td><%# Eval("add_time")%></td>
    <td><%# Eval("fileVersion")%></td>
    <td align="center"><a href="download.aspx?id_version=<%#Eval("id")%>">下载</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
