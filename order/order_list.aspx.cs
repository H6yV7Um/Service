...
public partial class order_order_list : BasePage
{
    ...
    {
        string sql = ChkGroup("select id,title,address,details,name,telephone,username,add_time,priority,state from dt_order where state='0' ");
        if (strWhere.Trim() != "")
        {
            sql += " and" + strWhere;
        }
