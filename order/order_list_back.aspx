<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list_back.aspx.cs" Inherits="order_order_list_back" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="5%">驳回人</th>
    <th align="left" width="9%">驳回时间</th>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%#Eval("state").ToString().Trim() == "2" ? "驳回" : "完成"%></td>
    <td align="center"><a href="order_edit.aspx?id=<%#Eval("id")%>&url=order_list_back">查看详情</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
