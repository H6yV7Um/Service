<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list_going_confirm.aspx.cs" Inherits="order_list_going_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%#Eval("state").ToString().Trim() == "4" ? "待确认" : "完成"%></td>
