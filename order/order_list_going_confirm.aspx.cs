...
public partial class order_list_going_confirm : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("order_list_going_confirm.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(Utils.CombUrlTxt("order_list_going_confirm.aspx", "", ""));
    }
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("order_list_going_confirm.aspx", "keywords={0}", txtKeywords.Text));
    }
    /// <summary>
    /// 获得查询分页数据
    /// </summary>
    ...
    {
        string sql = ChkGroup("select id,title,address,update_name,update_time, name,telephone,username,add_time,priority,state from dt_order where state='4'");
        if (strWhere.Trim() != "")
        {
            sql += " and" + strWhere;
        }
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("order_list_going_confirm.aspx");
    }
    public bool Update(int id)
    {
        string _name = Session["user_name"].ToString();
        ...
        if (_name == _firstUserName || getOADeptID(_name) == _deptID || role_id < 2 || getGroupIDByUserName(_name) == getGroupIDByUserName(_firstUserName) || getManagerModel(_name, "sms") == "1")
        {
