<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list_going_person.aspx.cs" Inherits="order_order_list_going_person" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.phone').click(function () {
            ...
            if (tel != "" && tel.length > 4) {
                jsdialog('联系方式', "<a href=\"tel:" + $(this).attr("title") + "\">" + $(this).text() + ":" + $(this).attr("title") + "</a>", "", "Success");
            } else {
                jsdialog('联系方式', "暂无联系方式", "", "Success");
            }
            //$.dialog.alert("<a href=\"tel:" + $(this).attr("title") + "\">联系电话：" + $(this).attr("title") + "</a>"); //获取title值. 
        });
        imgLayout();
...
<div class="toolbar-wrap">
  ...
  <div class="l-list">
      ...
      <li><asp:LinkButton ID="refresh" runat="server" CssClass="add" 
                onclick="refresh_Click" Visible="False"><i></i><span>刷新</span></asp:LinkButton></li>
       <li><a class="all" href="javascript:;" onclick="checkAll(this);" ><i></i><span>全选</span></a></li>
        <li><asp:LinkButton ID="btnUpdate" runat="server" CssClass="save" 
                OnClientClick="return ExePostBack1('btnUpdate');" onclick="btnUpdate_Click" Visible="True"><i></i><span>更改为已完成</span></asp:LinkButton></li>
                <li><asp:LinkButton ID="btn_Back" runat="server" CssClass="save" 
                OnClientClick="return ExePostBack1('btn_Back');" onclick="btn_Back_Click" Visible="False"><i></i><span>驳回</span></asp:LinkButton></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><%#getState(Eval("state").ToString().Trim())%></td>
    <td align="center"><a href="order_edit.aspx?id=<%#Eval("id")%>&url=order_list_going_person">查看详情</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
