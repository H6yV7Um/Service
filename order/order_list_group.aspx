<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list_group.aspx.cs" Inherits="order_order_list_group" %>
  ...
  <div class="l-list">
      <ul class="icon-list">
        ...
        <li><asp:LinkButton ID="btnUpdate" runat="server" CssClass="save" 
                OnClientClick="return ExePostBack1('btnUpdate');" onclick="btnUpdate_Click" Visible="False"><i></i><span>更改为处理中</span></asp:LinkButton></li>
    ...
    <div class="r-list">
      <asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword" placeHolder="输入工号查询" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="center" width="8%">待处理</th>
    <th align="center" width="8%">处理中</th>
    <th align="center" width="8%">已驳回</th>
    <th align="center" width="8%">已完成</th>
    <th align="center" width="8%">总工单</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    <td align="center"><%# getUserName(Eval("update_name").ToString())%></td>
    <td align="center"><%# Eval("total1")%></td>
    <td align="center"><%# Eval("total2")%></td>
    <td align="center"><%# Eval("total3")%></td>
    <td align="center"><%# Eval("total4")%></td>
