<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_list_person.aspx.cs" Inherits="order_order_list_person" %>
...
<ItemTemplate>
  <tr title="<%#getTitle(Eval("id").ToString()) %>">
    <td align="center" class="tdClass" ><%#getIDColor(Eval("id").ToString())%></td>
    <td align="center">
    ...
    <td align="center"><%#getState(Eval("state").ToString())%></td>
    <td align="center"><a href="order_edit_person.aspx?id=<%#Eval("id")%>&url=order_list">查看详情</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
